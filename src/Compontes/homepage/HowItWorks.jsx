...
const HowItWorks = () => {
    ...
    return (
        <section className="bg-black pt-20 overflow-hidden relative m-2 lg:m-[10px] rounded-lg">
            <div className="container mx-auto px-4">
                ...
                {/* Content Grid */}
                <div className="relative w-full mx-auto flex flex-col md:block items-center justify-center min-h-0 md:min-h-[700px]">

                    {/* Left Side Content - Positioned absolutely left or flex start */}
                    <div className="hidden md:flex absolute left-2 lg:left-8 top-[35%] -translate-y-1/2 flex-col items-end text-right z-30">
                    ...
                    <motion.svg
                        ...
                        className="absolute hidden md:block top-1/2 left-[22%] lg:left-[25%] -translate-y-[20%] w-40 h-40 pointer-events-none text-white z-10"
                        viewBox="0 0 100 100"
                        fill="none"
                    >
                        <path
                    ...
                    <motion.div
                        ...
                        className="relative md:absolute left-0 md:left-1/2 bottom-auto md:bottom-0 transform translate-x-0 md:-translate-x-1/2 z-20 flex justify-center items-end mt-10 md:mt-0"
                    >
                        <div className="relative w-[200px] sm:w-[250px] md:w-[320px] lg:w-[400px] flex justify-center items-center">
                            {/* Glow effect */}
                    ...
                    <div className="hidden md:flex absolute right-8 lg:right-32 top-1/2 -translate-y-1/2 flex-col items-start text-left z-30">
                        {/* Right Arrow */}
                        <motion.svg
                            initial={{ opacity: 0, pathLength: 0 }}
                            whileInView={{ opacity: 1, pathLength: 1 }}
                    ...
                    {/* Mobile Only View */}
                    <div className="md:hidden flex flex-col w-full relative z-30 mt-8 mb-10 px-4">
                        {/* We need margin-top to push it down below the absolute phone if we show it on mobile, 
                            but absolute usually breaks mobile flow. 
                            Let's keep the phone separate for mobile or adjust. 
                            For now, keeping the mobile list below. */}
                        <div className="flex flex-col items-center text-center gap-8 bg-black/50 backdrop-blur-sm p-4 rounded-xl">
                            <AnimatePresence mode="wait">
                                <motion.div
                                    key={currentStep}
